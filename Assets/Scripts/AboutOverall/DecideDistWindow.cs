...
public class DecideDistWindow : MonoBehaviour
{
    ...
    private const float DISAPPEAR_MIN = 0.1f;
    ...
    {
        // 全体の値に設定する
        CommonData.perfectDist = pValue_c_perfect;
        CommonData.goodDist = pValue_c_good;
        CommonData.missDist = pValue_c_miss;
        CommonData.neglectDist = pValue_c_neglect;
